...
namespace XEngine
{
    ...
    public class XPickBuffer
    {
        ...
        /// <summary>
        /// Creates the render target used to store pick id data as well as
        /// an internal depth buffer
        /// </summary>
        ...
        private void CreateBuffer(object sender, EventArgs e)
        {
            ...
            int bbw = dev.Viewport.Width;
            int bbh = dev.Viewport.Height;
        ...
        /// <summary>
        /// Disposes the pick buffer's render target and depth buffer
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DisposeBuffer(object sender, EventArgs e)
        {
            if (mBuffer != null)
                mBuffer.Dispose();
        ...
        /// <summary>
        /// Checks the current buffer sizes against the active graphics viewport,
        /// recreating the buffers to match if they differ
        /// </summary>
        private void CheckBuffer()
        {
            Viewport vp = mGraphics.GraphicsDevice.Viewport;

            if ((mBuffer == null) || (mDepthBuffer == null) || 
                (vp.Width != mBuffer.Width) || (vp.Height != mBuffer.Height)
                || (vp.Width != mDepthBuffer.Width) || (vp.Height != mDepthBuffer.Height))
            {
                DisposeBuffer(this, null);
                CreateBuffer(this, null);
            }
        }
