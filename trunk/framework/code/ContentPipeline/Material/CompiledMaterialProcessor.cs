...
namespace QuickStart.ContentPipeline.Material
{
    ...
    public class CompiledMaterialProcessor : ContentProcessor<CompiledMaterial, CompiledMaterial>
    {
        ...
        {
            input.compiledEffect = context.BuildAsset<EffectContent, CompiledEffect>(new ExternalReference<EffectContent>(string.Format("{0}{1}.fx", Path.GetFullPath("Effects/"), input.effect)), "EffectProcessor");
