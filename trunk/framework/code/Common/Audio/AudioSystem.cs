...
namespace QuickStart.Audio
{
    ...
    {        
        ...
        /// <param name="waveBankFilePath">The filepath to the .xwb file.</param>
        /// <param name="soundBankFilePath">The filepath to the .xsb file.</param>
        public void Initialize(string settingsFilePath, string waveBankFilePath, string soundBankFilePath)
        {
