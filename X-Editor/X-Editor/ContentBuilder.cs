...
namespace X_Editor
{
    ...
    public class ContentBuilder : IDisposable
    {
        ...
        //
        const string opipeVersion = ", Version=1.0.0.0";
        static string[] optionalPipelineAssemblies =
        {
            AppDomain.CurrentDomain.BaseDirectory + '\\'  + "XSIXNARuntime.dll",
            AppDomain.CurrentDomain.BaseDirectory + '\\'  + "Softimage.XWImporter.dll"
        };

        // MSBuild objects used to dynamically build content.
        Engine msBuildEngine;
        Project msBuildProject;
        ErrorLogger BuildLogger;
        ...
        void CreateBuildProject()
        {
            ...
            BuildLogger = new ErrorLogger();

            msBuildEngine.RegisterLogger(BuildLogger);
            ...
            foreach (string pipelineAssembly in optionalPipelineAssemblies)
            {
                msBuildProject.AddNewItem("Reference", pipelineAssembly);
            }
